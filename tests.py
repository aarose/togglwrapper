...
class TestProjects(TestTogglBase):
    ...
    def test_project_users_get(self):
        ...
        self.responses_add(
            "GET", filename=fixture_name, id=inst_id, child_uri="/project_users"
        )
...
class TestTasks(TestTogglBase):
    ...
    def test_mass_update(self):
        ...
        self.responses_add("PUT", "projectusers_update_multiple", ids=ids)
        update_data = {"task": {"active": False, "fields": "done_seconds,uname"}}
...
class TestTimeEntries(TestTogglBase):
    ...
    def test_stop(self):
        ...
        inst_id = 436694100
        self.responses_add(
            "PUT", filename="time_entry_stop", id=inst_id, child_uri="/stop"
        )
...
class TestWorkspaces(TestTogglBase):
    ...
    def test_users_get(self):
        ...
        inst_id = 777
        self.responses_add(
            "GET", filename="workspace_users", id=inst_id, child_uri="/users"
        )
    ...
    def test_clients_get(self):
        ...
        inst_id = 777
        self.responses_add(
            "GET", filename="workspace_clients", id=inst_id, child_uri="/clients"
        )
    ...
    def test_projects_get(self):
        ...
        inst_id = 777
        self.responses_add(
            "GET", "workspace_projects", id=inst_id, child_uri="/projects"
        )
    ...
    def test_tasks_get(self):
        ...
        inst_id = 777
        self.responses_add("GET", "workspace_tasks", id=inst_id, child_uri="/tasks")
    ...
    def test_tags_get(self):
        ...
        inst_id = 777
        self.responses_add("GET", "workspace_tags", id=inst_id, child_uri="/tags")
    ...
    def test_workspace_users_get(self):
        ...
        inst_id = 777
        self.responses_add(
            "GET", "workspace_workspaceusers", id=inst_id, child_uri="/workspace_users"
        )
    ...
    def test_invite(self):
        ...
        inst_id = 777
        self.responses_add("POST", "workspace_invite", id=inst_id, child_uri="/invite")
